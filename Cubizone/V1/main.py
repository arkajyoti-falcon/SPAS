...
# Paths / Assets
# =========================================================
COVER_TEMPLATE_PATH = r"assests\template.docx"     # cover template
FALCON_LOGO_PATH = r"assests\falcon.png"      # optional

SOLUTION_IMAGES = {
    "Cubizone-R": r"assests\r.PNG",
    "Cubizone-R Thru": r"assests\thru.PNG",
    "Cubizone-R Eco": r"assests\eco.PNG",
    "Cubizone-R Cross": r"assests\cross.PNG",
    "Cubizone-V Eco": r"assests\v-eco.PNG",
    "Cubizone-V Jumbo": r"assests\v-jumbo.PNG",
}
...
def add_header_footer_to_section(section, header_title: str, client_logo: Optional[bytes]):
...
def build_offer_docx(
    ...
    add_header_footer_to_section(section2, header_title, client_logo)
...
def render_cubizone_builder(embed_mode: bool = False):
    ...
    def _on_solution_change():
        """Force price sheet to rebuild when solution type changes."""
        st.session_state.pop("price_df", None)
        st.session_state.pop("price_df_type", None)
    ...
    with tab1:
        ...
        with col1:
            ...
            st.selectbox(
                "Solution Type",
                solution_types,
                key="cubizone_solution_type",
                help="Select the Cubizon solution type for this proposal",
                on_change=_on_solution_change,
            )
            st.session_state["solution_type"] = st.session_state["cubizone_solution_type"]
    ...
    with tab2:
        ...
        if "price_df" not in st.session_state or st.session_state.get("price_df_type") != st.session_state["solution_type"]:
